...
Владелец запретил Playwright вам прямой командой. Мои агенты принимают мобильную
вёрстку в WebKit через Playwright по его же правилу от 11.09 («мобилку только
в WebKit»). Противоречие вынесено владельцу; до его слова каждый остаётся в
своём правиле.
