...
export const ERAS: Era[] = [
  { key: 'e2010', label: '2010-е', title: 'Эпоха офшоринга и мобильных платформ', summary: 'Мир покупал «дешёвые руки»: офшоринг разработки, колл-центры, ввод данных. Мобильные платформы создали рынки приложений и рекламы.' },
  { key: 'e2020', label: '2020-2023', title: 'Пандемийный сдвиг и подписки', summary: 'Карантин перенёс жизнь в цифру: облака, доставка, стриминг, удалёнка. SaaS стал нормой.' },
  { key: 'e2026', label: '2024-2026', title: 'Эпоха ИИ-агентов и переписывания услуг', summary: 'ИИ перестал быть фичей и стал исполнителем: агенты пишут код, ведут поддержку, делают маркетинг.' },
  { key: 'e2030', label: 'к 2030', title: 'Проектируемое будущее: агенты-коллеги', summary: 'Прогноз-ориентир: большая часть цифровых рутин выполняется агентами, люди — в контроле, творчестве и контакте.' }
];

// Относительная популярность услуг (0-100), оценки.

export const SERVICE_ERAS: ServiceEraStat[] = [
  { serviceId: 'health_data', era: 'e2010', demand: 28, note: 'EHR и лабораторные системы развиваются раздельно' },
  { serviceId: 'health_data', era: 'e2020', demand: 55, note: 'Удалённая медицина и wearables расширяют поток данных' },
  { serviceId: 'health_data', era: 'e2026', demand: 82, note: 'Интероперабельность, consent и доменные данные становятся активом' },
  { serviceId: 'health_data', era: 'e2030', demand: 94, note: 'Непрерывные данные встраиваются в preventive и clinical workflows (прогноз)' },
  { serviceId: 'medical_ai', era: 'e2010', demand: 12, note: 'Отдельные экспертные системы и early imaging pilots' },
  { serviceId: 'medical_ai', era: 'e2020', demand: 38, note: 'Рост моделей для imaging и документации' },
  { serviceId: 'medical_ai', era: 'e2026', demand: 78, note: 'Регуляторные списки и клинические deployments расширяются' },
  { serviceId: 'medical_ai', era: 'e2030', demand: 96, note: 'AI становится слоем clinical workflow при доказанной пользе (прогноз)' },
  { serviceId: 'diagnostics', era: 'e2010', demand: 48, note: 'Цифровая визуализация и лабораторная автоматизация' },
  { serviceId: 'diagnostics', era: 'e2020', demand: 63, note: 'Удалённый скрининг и рост диагностических данных' },
  { serviceId: 'diagnostics', era: 'e2026', demand: 84, note: 'AI-assisted diagnostics с регуляторными ограничениями' },
  { serviceId: 'diagnostics', era: 'e2030', demand: 95, note: 'Скрининг смещается к раннему выявлению и персонализации (прогноз)' },
  { serviceId: 'care_delivery', era: 'e2010', demand: 35, note: 'Офлайн-маршрутизация и разрозненные сервисы' },
  { serviceId: 'care_delivery', era: 'e2020', demand: 65, note: 'Телемедицина и удалённое сопровождение' },
  { serviceId: 'care_delivery', era: 'e2026', demand: 86, note: 'Навигация и координация становятся цифровым слоем care' },
  { serviceId: 'care_delivery', era: 'e2030', demand: 96, note: 'Гибридная модель человек + AI navigator (прогноз)' },
